...
import type { ForumPost, ForumComment } from '@/features/forum/types'
  ...
  if (!post) {
    return (
      <div className="text-center py-12">
        ...
        <Button variant="outline" onClick={() => router.push('/pilot/foro')}>
          <ArrowLeft className="h-4 w-4 mr-2" />
          Volver al foro
        </Button>
      </div>
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-3 mb-2">
        <Button
          ...
          size="icon"
          className="h-8 w-8"
          onClick={() => router.push('/pilot/foro')}
        >
      ...
      <PostCard
        post={post}
        showFullContent
        onDeleted={() => router.push('/pilot/foro')}
