...
const FEATURES = [
  {
    ...
    desc: 'FIDS agregado por ti para ayudar a los demás: estado de vuelos, puertas y retrasos. Incluye Tipo de Cambio USD/MXN. Disponible para TIJ y MEX.',
  },
  {
    icon: Wind,
      ...
      <section className="relative pt-36 pb-24 px-4 overflow-hidden">
        ...
        <div className="max-w-2xl mx-auto text-center relative">
          ...
          <p className="text-zinc-400 text-lg leading-relaxed mb-10 max-w-xl mx-auto">
            Salidas en tiempo real (creadas por nosotros para apoyar a otros), meteorología, comunicación entre tripulaciones y
